...
import management.hostel.utils.ProblemDetailJson;
...
public interface ValidationExceptionHandler {
	...
	default ProblemDetailJson httpMessageNotReadableException(HttpMessageNotReadableException exception) {
		return ProblemDetailJson.forStatusAndDetail(HttpStatus.BAD_REQUEST, exception.getMessage());
	}

	@ResponseStatus(HttpStatus.BAD_REQUEST)
	@ExceptionHandler(BindException.class)
	default ProblemDetailJson bindException(BindException exception) {
	...
	default ProblemDetailJson resourceAlreadyExistException(ResourceAlreadyExistException exception) {
	...
	default ProblemDetailJson resourceNotFoundException(ResourceNotFoundException exception) {
		return ProblemDetailJson.create()
